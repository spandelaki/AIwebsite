    ...
    <main>
      ...
      >
        <div
          ...
          style="
            background-image: url('https://drive.google.com/uc?export=view&id=1xlQkVj7mjFHg6aEAsonydBW9-GJdA26T');
          "
        >
          <span
            id="blackOverlay"
            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Pendidikan</h6>
            ...
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Penelitian</h6>
                  <p class="mt-2 mb-4 text-blueGray-500">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua.
            ...
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Pengabdian</h6>
                  <p class="mt-2 mb-4 text-blueGray-500">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua.
          ...
          <div class="items-center flex flex-wrap">
            ...
            <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <h3 class="text-3xl font-semibold">Our Projects</h3>
                ...
                <ul class="list-none mt-6">
                  ...
                  <li class="py-2">
                    <div class="flex items-center">
                      ...
                      <div>
                        <h4 class="text-blueGray-500">AI</h4>
                      </div>
                    </div>
                  </li>
                </ul>
        ...
        <div class="container mx-auto px-4">
          <div class="flex flex-wrap justify-center text-center mb-24">
            <div class="w-full lg:w-6/12 px-4">
              <h2 class="text-4xl font-semibold">Here are our members</h2>
            ...
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                ...
                <div class="pt-6 text-center">
                  <h5 class="text-md font-bold">Angelia Melani Adrian, Ph.D</h5>
                  <p
...
import team1 from "@/assets/img/melani.jpg";
import team2 from "@/assets/img/imma.jpg";
import team3 from "@/assets/img/ucok.jpg";
import team4 from "@/assets/img/steven.jpeg";
